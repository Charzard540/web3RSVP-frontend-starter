...
export default function CreateEvent() {
  ...
  async function handleSubmit(e) {
    ...
    //We are using state variables to keep track of the form data. 
    //We'll organize them into a single object that we'll use to pass to our 
    //API endpoint which will store some of our event data off-chain via Web3.Storage
